...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.vbox.addLayout(self.hbox_clean)
        ...
        self.b_clean = QPushButton("CE", self)
        self.hbox_clean.addWidget(self.b_clean)
    ...
    def _result(self):
        ...
        if self.op =="+":
            ...
            if self.num_2 == 0:
                self.input.setText('Error! Недопустимое действие!')
            else:
                self.input.setText(str(self.num_1 / self.num_2))
